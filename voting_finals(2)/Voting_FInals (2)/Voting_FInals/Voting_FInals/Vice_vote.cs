...
{
    public partial class vice_vote : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "UPDATE Vote_Table SET VicePresident_Vote ='Ronaldo' WHERE Student_Number='" + ID_Num.Text + "'";
            cmd.ExecuteNonQuery();
            con.Close();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = con.CreateCommand();
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "UPDATE Vote_Table SET VicePresident_Vote ='Messi' WHERE Student_Number='" + ID_Num.Text + "'";
            cmd.ExecuteNonQuery();
            con.Close();
